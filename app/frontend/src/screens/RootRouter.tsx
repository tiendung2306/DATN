...
import { GetAppState, GetRuntimeHealth, GetSessionStatus } from '../../wailsjs/go/service/Runtime'
import AwaitingBundleScreen from './AwaitingBundleScreen'
...
export default function RootRouter() {
  ...
  if (appState === 'LOADING') {
    return (
      <AppShell title="Secure P2P Node" subtitle="Frontend FE-1 foundation">
  ...
  return <MainAppScreen isAdmin={appState === 'ADMIN_READY'} />
}
