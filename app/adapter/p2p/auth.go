...
func OnboardNewUser(
	...
	return database.SaveMLSIdentity(&store.MLSIdentity{
...
func GetOnboardingInfo(database *store.Database, libp2pPrivKey crypto.PrivKey) (*OnboardingInfo, error) {
...
func BuildLocalToken(b *store.StoredAuthBundle) *admin.InvitationToken {
