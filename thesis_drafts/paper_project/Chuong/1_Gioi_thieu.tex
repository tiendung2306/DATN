...
Trên cơ sở định hướng nêu trên, các đóng góp của đồ án có thể chia thành ba nhóm.

Về thiết kế giải pháp, đồ án xác định bài toán trung tâm của MLS trên mạng ngang hàng dưới góc nhìn nhất quán trạng thái mật mã, qua đó làm rõ rằng khó khăn cốt lõi không nằm ở việc truyền thông điệp mà nằm ở việc duy trì chuỗi trạng thái nhóm hợp lệ khi không còn Delivery Service trung tâm.

Trên cơ sở đó, đồ án đề xuất một lớp điều phối phi tập trung bao quanh MLS, phối hợp bốn cơ chế — Single-Writer theo epoch, kiểm tra nhất quán epoch, phát hiện phân nhánh và Fork Healing, đồng hồ logic lai HLC — để giảm nguy cơ phân nhánh và hỗ trợ hệ thống hội tụ trở lại.

Về triển khai hệ thống, đồ án xây dựng một ứng dụng desktop tích hợp mạng P2P, lưu trữ cục bộ và lõi mật mã MLS/OpenMLS. Các luồng khởi tạo định danh, cấp bundle, quản trị tổ chức và trò chuyện nhóm được triển khai trọn vẹn để kiểm chứng khả năng triển khai của hướng tiếp cận đã đề xuất.

Về đánh giá thực nghiệm, đồ án đo đạc tính hội tụ trạng thái, khả năng phục hồi sau phân vùng mạng và tác động của lớp điều phối đối với quá trình vận hành MLS trong môi trường ngang hàng.

\section{Bố cục đồ án}
\label{sec:bo-cuc}

Phần còn lại của báo cáo được tổ chức như sau. Chương 2 trình bày cơ sở lý thuyết của đề tài, bao gồm nền tảng MLS, TreeKEM, vai trò của Delivery Service, các hướng tiếp cận liên quan và những đặc tính của môi trường mạng ngang hàng có ảnh hưởng trực tiếp tới bài toán nhất quán trạng thái. Trên nền tảng đó, Chương 3 trình bày chi tiết giao thức điều phối phi tập trung được đề xuất, làm rõ các thành phần, nguyên tắc hoạt động, cách phối hợp giữa lớp điều phối với lõi mật mã MLS, đồng thời giới thiệu ứng dụng desktop minh họa như môi trường triển khai của các quyết định thiết kế.
