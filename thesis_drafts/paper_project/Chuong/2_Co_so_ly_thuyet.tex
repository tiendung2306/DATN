...
(ii) Đối với đồng thuận chuỗi khối (\textit{blockchain-based}), việc sử dụng blockchain để tạo ra một nhật ký tuyến tính chung giải quyết được bài toán thiếu máy chủ trung tâm. Tuy nhiên, kiến trúc này sinh ra độ trễ (latency) tạo khối rất cao, hoàn toàn không đáp ứng được yêu cầu thời gian thực của một ứng dụng trò chuyện. Ngoài ra, việc thiết lập và duy trì một mạng lưới blockchain cũng như cơ chế đồng thuận riêng cho từng nhóm chat độc lập là một sự lãng phí tài nguyên không cần thiết.
