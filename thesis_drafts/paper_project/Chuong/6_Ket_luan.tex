...
Một giới hạn khác liên quan đến độ sâu phân kỳ. Thí nghiệm cho thấy thời gian healing tăng khi hai nhánh đã lệch nhiều epoch, từ 1039 ms ở độ sâu 10 lên 2098 ms ở độ sâu 50. Mặc dù giao thức fork healing luôn thực hiện đúng một chu kỳ bất kể độ sâu phân kỳ và External Proposal giữ số Commits luôn bằng 1, phần chi phí nằm ở kích thước group state phình to qua từng epoch --- do OpenMLS tuần tự hóa toàn bộ ratchet tree và lõi Rust stateless nhận nguyên group state qua gRPC mỗi lần gọi. Đây là hạn chế của kiến trúc triển khai hiện tại, là điểm cần tối ưu thêm nếu muốn hệ thống phục hồi nhanh hơn sau phân vùng kéo dài.
