...
\begin{figure}
\centering
\includegraphics[width=0.75\linewidth]{Hinh_ve/IoT.png}
...
\begin{figure}
\centering
\includegraphics[width=0.5\linewidth]{Hinh_ve/Bia.PNG}
...
\begin{figure}
\centering
\includegraphics[width=0.5\linewidth]{Hinh_ve/GayBia.PNG}
\caption{Qui cách đóng quyển đồ án}
\label{fig:GayBia}
\end{figure} 
